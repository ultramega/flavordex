...
public class CSVParser {
    ...
    /**
     * Constructs CSVReader with supplied separator and quote char. Allows setting the "strict
     * quotes" flag
     *
     * @param separator    the delimiter to use for separating entries
     * @param quotechar    the character to use for quoted elements
    ...
    /**
     * Constructs CSVReader with supplied separator and quote char. Allows setting the "strict
     * quotes" and "ignore leading whitespace" flags
     *
     * @param separator               the delimiter to use for separating entries
     * @param quotechar               the character to use for quoted elements
     * @param escape                  the character to use for escaping a separator or quote
     * @param strictQuotes            if true, characters outside the quotes are ignored
     * @param ignoreLeadingWhiteSpace if true, white space in front of a quote in a field is
     *                                ignored
     */
