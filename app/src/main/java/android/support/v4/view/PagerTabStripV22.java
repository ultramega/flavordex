...
/**
 * PagerTabStrip is an interactive indicator of the current, next, and previous pages of a {@link
 * android.support.v4.view.ViewPager}. It is intended to be used as a child view of a ViewPager
 * widget in your XML layout. Add it as a child of a ViewPager in your layout file and set its
 * android:layout_gravity to TOP or BOTTOM to pin it to the top or bottom of the ViewPager. The
 * title from each page is supplied by the method {@link android.support.v4.view.PagerAdapter#getPageTitle(int)}
 * in the adapter supplied to the ViewPager. <p/> <p>For a non-interactive indicator, see {@link
 * PagerTitleStripV22}.</p>
 */
public class PagerTabStripV22 extends PagerTitleStripV22 {
    ...
    /**
     * Set whether this tab strip should draw a full-width underline in the current tab indicator
     * color.
     *
    ...
    /**
     * Return whether or not this tab strip will draw a full-width underline. This defaults to true
     * if no background is set.
     *
     * @return true if this tab strip will draw a full-width underline in the current tab indicator
     * color.
     */
