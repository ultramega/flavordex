...
--
INSERT INTO entries VALUES (1, 'e030e11e-99c2-4f5e-95c4-6c6740503113', 3, 'Jefferson’s Straight Rye Whiskey', 1, '$36/bottle', 'Home', 1354137274000, 4.0, 'Quick burst of fruit followed by mellow rye spice & dryness, has a grassy linger. There is a certain funk to it that’s VERY subtle, and almost grappa like - very faint and not unpleasant. Makes an above average old fashioned and Manhattan and good neat but not my preferred rye for a session but definitely a dynamic tasting. Chewy linger w/ the grass and leather.', 0, 0, 0, 0, NULL);
--
INSERT INTO entries VALUES (2, '3c6c9966-c78a-4a54-93e8-2eb443babdee', 1, 'Pliney The Elder', 2, '$5', 'Bottleworks', 1372219156000, 4.5, 'Profoundly balanced given the alcohol content, hops, and light body. All the characteristics of an imperial but the sum is greater than the parts.', 0, 0, 0, 0, NULL);
--
INSERT INTO entries VALUES (3, 'f414553c-c749-458d-b82b-bc18fd9faedd', 2, '2009 Old Vine Cuvee', 3, '$9', '', 1337526402000, 3.5, 'Rich & mineral heavy but with a brightness & heat bursting through to prevent it from lingering metallic, instead leaving behind rich, concentrated cherry and pleasant warmth.', 0, 0, 0, 0, NULL);
--
INSERT INTO entries VALUES (4, '2ced63c2-0569-449a-a3c6-608f5f39c5e4', 4, 'Ethiopia Gedeo', 4, '$2', 'Herkimer', 1337526009000, 4.0, 'Strong smell and taste of blueberry, balanced, medium body doesn''t overexpose the dark berry flavor - easy. I like turtles.', 0, 0, 0, 0, NULL);
--
